...
func TestWalkerMapKeys_complex_types(t *testing.T) {
	...
	g.Expect(field2.FieldName).To(Equal("ComplexMapKeys"))
	...
	g.Expect(field3.FieldName).To(Equal("ComplexMapKeys[key: child one map key]"))
	...
	g.Expect(field4.FieldName).To(Equal("ComplexMapKeys[child one map key]"))
	...
	g.Expect(field5.FieldName).To(Equal("ComplexMapKeys[child one map key].Name"))
	...
	g.Expect(field6.FieldName).To(Equal("ComplexMapKeys[child one map key].ComplexMapKeys"))
	...
	g.Expect(field7.FieldName).To(Equal("ComplexMapKeys[child one map key].ComplexMapKeys[key: grandchild one map key]"))
	...
	g.Expect(field8.FieldName).To(Equal("ComplexMapKeys[child one map key].ComplexMapKeys[grandchild one map key]"))
	...
	g.Expect(field9.FieldName).To(Equal("ComplexMapKeys[child one map key].ComplexMapKeys[grandchild one map key].Name"))
	...
	g.Expect(field10.FieldName).To(Equal("ComplexMapKeys[child one map key].ComplexMapKeys[grandchild one map key].ComplexMapKeys"))
