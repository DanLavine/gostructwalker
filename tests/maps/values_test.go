...
func TestWalkerMapValues_simple_types(t *testing.T) {
	...
	g.Expect(field1.FieldName).To(Equal("MapValues"))
	g.Expect(field1.ParsedTags).To(Equal(gostructwalker.Tags{Field: "minLength=100", MapValues: "maxLength=200"}))
	...
	g.Expect(field2.FieldName).To(Equal("MapValues[key: one]"))
	...
	g.Expect(field3.FieldName).To(Equal("MapValues[one]"))
...
func TestWalkerMapValues_complex_types(t *testing.T) {
	...
	g.Expect(field2.FieldName).To(Equal("ComplexMapValues"))
	g.Expect(field2.ParsedTags).To(Equal(gostructwalker.Tags{Field: "minLength=200", MapValues: "required=true"}))
	...
	g.Expect(field3.FieldName).To(Equal("ComplexMapValues[key: child one map key]"))
	...
	g.Expect(field4.FieldName).To(Equal("ComplexMapValues[child one map key]"))
	g.Expect(field4.ParsedTags).To(Equal(gostructwalker.Tags{Field: "required=true"}))
	...
	g.Expect(field5.FieldName).To(Equal("ComplexMapValues[child one map key].Name"))
	...
	g.Expect(field6.FieldName).To(Equal("ComplexMapValues[child one map key].ComplexMapValues"))
	g.Expect(field6.ParsedTags).To(Equal(gostructwalker.Tags{Field: "minLength=200", MapValues: "required=true"}))
	...
	g.Expect(field7.FieldName).To(Equal("ComplexMapValues[child one map key].ComplexMapValues[key: grandchild one map key]"))
	g.Expect(field7.ParsedTags).To(Equal(gostructwalker.Tags{}))
	...
	g.Expect(field8.FieldName).To(Equal("ComplexMapValues[child one map key].ComplexMapValues[grandchild one map key]"))
	g.Expect(field8.ParsedTags).To(Equal(gostructwalker.Tags{Field: "required=true"}))
	...
	g.Expect(field9.FieldName).To(Equal("ComplexMapValues[child one map key].ComplexMapValues[grandchild one map key].Name"))
	...
	g.Expect(field10.FieldName).To(Equal("ComplexMapValues[child one map key].ComplexMapValues[grandchild one map key].ComplexMapValues"))
	g.Expect(field10.ParsedTags).To(Equal(gostructwalker.Tags{Field: "minLength=200", MapValues: "required=true"}))
